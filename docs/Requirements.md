...
<table>
  ...
  <tbody>
    ...
    <tr class="muss">
      <td>F1.3</td>
      <td>Einstellung</td>
      <td>Jedes Stichmuster hat 2 Parameter: Stichlänge/breite und Stichmuster. Bei der Auswahl eines Musters werden die dazugehörigen Parameter geladen</td>
    </tr>
    <tr class="kann">
      <td>F1.4</td>
      <td>Anzeige SM</td>
...
<table>
  ...
  <tbody>
    <tr class="soll">
      ...
      <td>Das Produkt soll in Java entwicklet werden.</td>
    </tr>
    <tr class="soll">
      <td>NF7.2</td>
      <td>Budget</td>
