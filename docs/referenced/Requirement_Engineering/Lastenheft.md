...
<table>
  ...
  <tbody>
    ...
    <tr class="muss">
      <td>F1.2</td>
      <td>Auswahl SM</td>
      <td>Die Stichmuster müssen über ein Drehrad auswählbar sein.</td>
    </tr>
    <tr class="muss">
      <td>F1.3</td>
    ...
    <tr class="kann">
      <td>F3.4</td>
      <td>LED Anzeige</td>
      <td>Die Helligkeitsstufe und der Modus ( An/Aus/Auto) sollen angezeigt werden.</td>
    </tr>
    <tr class="muss">
      <td>F4.1</td>
      <td>Fadenspannung</td>
